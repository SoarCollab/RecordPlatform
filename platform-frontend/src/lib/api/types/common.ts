...
export const ResultCode = {
  ...
  BLOCKCHAIN_TIMEOUT: 30012,
  BLOCKCHAIN_UNREACHABLE: 30013,
  STORAGE_QUORUM_NOT_REACHED: 30014,
  STORAGE_INSUFFICIENT_REPLICAS: 30015,
  STORAGE_DEGRADED_WRITE: 30016,
  ...
  UPLOAD_SESSION_NOT_FOUND: 40006,
  ENCRYPTION_ERROR: 40007,
  ...
  SHARE_EXPIRED: 50012,
  /** 配额超限 */
  QUOTA_EXCEEDED: 50013,
  /** 版本链不存在 */
  VERSION_CHAIN_NOT_FOUND: 50014,
  /** 版本创建冲突 */
  VERSION_CONFLICT: 50015,
  /** 源文件状态不允许创建新版本 */
  VERSION_SOURCE_INVALID: 50016,
  ...
  // 好友系统错误 60010-60019
  NOT_FRIENDS: 60010,
  FRIEND_REQUEST_EXISTS: 60011,
  ALREADY_FRIENDS: 60012,
  CANNOT_ADD_SELF: 60013,
  FRIEND_REQUEST_NOT_FOUND: 60014,
  FRIEND_REQUEST_PROCESSED: 60015,
  FRIEND_SHARE_NOT_FOUND: 60016,
  FRIEND_SHARE_UNAUTHORIZED: 60017,

  // 权限错误 70000-79999
  PERMISSION_UNAUTHENTICATED: 70001,
  PERMISSION_UNAUTHORIZED: 70002,
  PERMISSION_EXPIRE: 70003,
...
export const RETRYABLE_CODES = [
  ...
  ResultCode.BLOCKCHAIN_TIMEOUT,
  ResultCode.BLOCKCHAIN_UNREACHABLE,
  ResultCode.STORAGE_QUORUM_NOT_REACHED,
  ResultCode.STORAGE_INSUFFICIENT_REPLICAS,
];

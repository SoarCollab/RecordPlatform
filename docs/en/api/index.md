...
| POST | `/api/v1/files/key-grants/consume` | Consume an authenticated short-lived download key grant |
...
| POST | `/api/v1/public/key-grants/consume` | Consume a public-share short-lived key grant (public) |
